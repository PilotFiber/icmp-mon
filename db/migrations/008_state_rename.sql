...
-- =============================================================================
-- ADD 'down' TO ENUM TYPE
-- =============================================================================

-- First add 'down' to the monitoring_state enum
-- PostgreSQL requires this before we can use it as a value
...
VALUES ('system', 'config_changed',
    '{"migration": "008_state_rename", "description": "Added down state to monitoring_state enum. degraded now means packet loss/latency issues, down means complete outage."}',
    'system', 'info');
